    ...
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-32 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-4 sm:flex-row"><a href="#shop" className="rounded-full bg-[#0b5f59] px-7 py-4 text-center font-semibold text-white shadow-xl shadow-teal-900/20">Shop frames</a><Link href="/checkout" className="rounded-full border border-[#11263d]/25 bg-white px-7 py-4 text-center font-semibold text-[#11263d] hover:border-[#11263d]">Try payment flow</Link></div>
        ...
        <div className="glass-card stripe-shadow rounded-[2.5rem] p-5"><FrameArt gradient="from-teal-200 via-stone-100 to-amber-100" /><div className="mt-5 grid grid-cols-2 gap-4"><div className="rounded-3xl bg-[#11263d] p-5 text-white"><p className="text-sm text-[#e8f0ef]">New flow</p><b className="text-3xl">Full cart</b><p className="mt-3 text-sm text-[#e8f0ef]">Dedicated cart and checkout pages.</p></div><div className="rounded-3xl bg-white p-5"><p className="text-sm text-[#334155]">Realistic form</p><b className="text-3xl text-[#11263d]">Payment</b><p className="mt-3 text-sm text-[#334155]">Card, PayPal, Apple Pay, billing, shipping.</p></div></div></div>
      </section>
